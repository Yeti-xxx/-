        ...
        <div class="main">
            <div class="info">
                ...
                <ul class="foot">
                    ...
                    <li>
                        <button class="btn" @click="goPay">确认订单</button>
                    </li>
                </ul>
            </div>
        </div>
...
// api
import { settlement, alipayOrder, queryOrder, wxpayOrder, queryWxpay } from '../utils/api/order'
...
const goPay = () => {
    ...
    if (payment.code == 'alipayment') {
        timer.value = setInterval(interPaymentAli, 1500)
    }else{
        timer.value = setInterval(interPaymentWx, 1500)
    }
