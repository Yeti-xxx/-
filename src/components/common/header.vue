	...
	<header @mouseleave='isShow = false'>
		<div class='header-content'>
			<h1 class='content-logo'>
				<img src="	https://www.xuexiluxian.cn/resources/images/index/logo.png">
			</h1>
			...
			<div class='search-buy-login'>
				...
				<div class="content-login-success" v-else>
					...
					<div @mouseenter='isShow = true'>
						...
						<img v-else class="avator" src='https://www.xuexiluxian.cn/resources/images/blog/notebook.png' />
					</div>
				</div>
				<!-- 划过头像显示  -->
				<div class="user-info" v-if='isShow'>
					<div class="user-info-top">
						<div class="u-i-t-top">
							<img class="avator" :src="userInfo.avatar" alt="" v-if="userInfo.avatar" />
							<img class="avator" src='	https://www.xuexiluxian.cn/resources/images/blog/notebook.png' v-else />
