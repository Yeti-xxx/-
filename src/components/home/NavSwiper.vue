    ...
    <div class='navSwiper'>
                        ...
                        <div class='category-detail' v-if="isFirst">
                            <div class='detail-main'>
                                ...
                                <div class='detail-list'>
                                    ...
                                    <div class='list-ul'>
                                        <router-link to='/' class='list-item' v-for="item in tagPagrList" :key="item.id">
                                            {{ item.tagName }}
                                        </router-link>
                                    </div>
                                </div>
                                    ...
                                    <div class='detail-class'>
                                        <div class='course-card' v-for='item in searchCourseList' :key='item.id'>
                                            ...
                                            <div class='right'>
                                                ...
                                                <div class="courseDegree">{{ item.courseLevel }} · {{ item.purchaseCounter +
        ...
        <div class='course-type'>
            <div class='course-type-item'>
                <router-link to='/'>
                    <div class='course-type-item-icon'>
                        <img src="https://www.xuexiluxian.cn/resources/images/index/chuji.png">
                    </div>
            ...
            <div class='course-type-item'>
                <router-link to='/'>
                    <div class='course-type-item-icon'>
                        <img src="	https://www.xuexiluxian.cn/resources/images/index/zhongji.png">
                    </div>
                    <div class='course-type-item-text'>
            ...
            <div class='course-type-item'>
                <router-link to='/'>
                    <div class='course-type-item-icon'>
                        <img src="	https://www.xuexiluxian.cn/resources/images/index/gaoji.png">
                    </div>
                    <div class='course-type-item-text'>
            ...
            <div class='course-type-item'>
                <router-link to='/'>
                    <div class='course-type-item-icon'>
                        <img src="https://www.xuexiluxian.cn/resources/images/index/suanfa.png">
                    </div>
                    <div class='course-type-item-text'>
...
import { getFirstCategorys, tagList, searchCourse,getSlider } from '../../utils/api/courseManage'
...
const mourseHover = (id) => {
    ...
    if (id !== 'fd50074e7b86403aa2ac1168abe020a0') {
        ...
        // 查询课程标签
        tagList(tagParams).then(res => {
            tagPagrList.value = res.data.pageInfo.list
